...
<template>
  <div class="flex-auto flex flex-col items-center h-64">
      <div class="flex flex-col items-center relative">
          <div class="w-full  svelte-1l8159u">
              <div class="my-2 bg-white p-1 flex border border-gray-200 rounded svelte-1l8159u">
                  <div class="flex flex-auto flex-wrap"></div>
                    <input v-on:focus="handleFocus" v-on:blur="handleBlur" value="Javascript" class="p-1 px-2 appearance-none outline-none w-full text-gray-800  svelte-1l8159u">
                  <div>
          ...
          <div class="absolute shadow top-100 z-40 w-full lef-0 rounded max-h-select overflow-y-auto svelte-5uyqqj" v-if="showOptions">
